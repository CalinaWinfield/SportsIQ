...
import { db, ScoreRecord } from '../db.js';
import { optionalAuth, authenticateToken, AuthenticatedRequest } from '../auth.js';
...
router.get('/user-stats', authenticateToken, (req: AuthenticatedRequest, res) => {
  if (!req.user) {
